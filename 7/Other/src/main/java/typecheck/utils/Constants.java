...
public interface Constants {
    ...
    String ERROR_COND_TYPE_ERROR = "\"same typecheck.type expected for if branches\"";
    String ERROR_FUNCTION_EXPECTED = "\"function typecheck.type expected\"";
    ...
    String ERROR_DECL_TYPE_MATCHING = "\"matching typecheck.type declarations and types expected in Decl\"";
}
