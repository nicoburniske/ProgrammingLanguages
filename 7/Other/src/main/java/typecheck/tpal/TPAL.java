 ...
 *     <li>- a JSON array of the shape [{@link typecheck.tpal.decl.TPALDecl},...,{@link typecheck.tpal.decl.TPALDecl},{@link TPAL}]
...
public interface TPAL {
    ...
    /**
     * This function takes in an enviroment an uses it ot typecheck.type check the TPAL to confirm if it is a valid exression.
     * @param env the enviroment used to typecheck.type check the TPAL
