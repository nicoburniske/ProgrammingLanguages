...
public class ConditionalTest {
    ...
    public void testInterpret() {
        assertEquals(new BigInteger("10"), this.ifFalse.interpret(new Store<Var, Answer>()).result);
        assertEquals(new BigInteger("25"), this.ifTrue.interpret(new Store<Var, Answer>()).result);
    }
}
