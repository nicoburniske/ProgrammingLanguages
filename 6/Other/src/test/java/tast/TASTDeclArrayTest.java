...
public class TASTDeclArrayTest {
    ...
    public void toJSONString() {
        ...
        List<StarDecl> decls2 = Arrays.asList(new StarDecl(new TVar("b", new TypeInt()), new StarAST(new TASTVar("c"), new TypeInt())));
        ...
        List<StarDecl> decls3 = Arrays.asList(new StarDecl(new TVar("c", new TypeInt()), new StarAST(new TASTVar("c"), new TypeInt())), decls2.get(0));
