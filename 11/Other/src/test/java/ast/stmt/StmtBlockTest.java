...
class StmtBlockTest {
    ...
    void setUp() {
        ...
        result2 = new IValueArray(new Location(1), 3);
        result2Store = new Store().put(new Location(0), new IValueArray(1,3)).put(new Location(1), new IValueInt(1)).put(new Location(2), new IValueInt(2)).put(new Location(3), new IValueInt(3));
        ...
        result3 = new IValueArray(new Location(1), 3);
        result3Store = new Store().put(new Location(0), new IValueArray(1,3)).put(new Location(1), new IValueInt(1)).put(new Location(2), new IValueInt(5)).put(new Location(3), new IValueInt(3));
    }
